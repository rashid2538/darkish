...
class HTML
{
    ...
    private function getValue($name)
    {
        if (is_object($this->_model)) {
            ...
            isset($this->_model[$name]) ? $this->_model[$name] : '';
        }
        return '';
    }
    ...
    public function input($name, $attrs = [], $label = '', $value = null)
    {
        if (!isset($attrs['type'])) {
            $attrs['type'] = 'text';
        }
    ...
    public function select($name, $options, $attrs = [], $label = '', $value = null)
    {
        if (!is_null($label)) {
            $label = $label ? $label : $this->createLabel($name);
        }
    ...
    public function textarea($name, $attrs = [], $label = '', $value = null)
    {
        if (!isset($attrs['type'])) {
            $attrs['type'] = 'text';
        }
